...
| BEFORE | AFTER |
| ----------- | ----------- |
| ![A screenshot of the Digital Skills Anth collection on Research Rabbit. Two articles are inside: "Will It Ever Be FAIR?" by Nicholson et al. 2023, and "Data Beyond the Archive in Digital Archaeology" by Kansa et al. 2018.](1.png) | ![Another screenshot of the Digital Skills Anth collection on Research Rabbit. This time, three articles are inside: "Will It Ever Be FAIR?" by Nicholson et al. 2023, and "Data Beyond the Archive in Digital Archaeology" by Kansa et al. 2018, and "The FAIR Guiding Principles for scientific data management and stewardship" by Wilkinson et al. 2016. The last article was added by Serisen Bardsley.](2.png) |
...
![A screenshot of the connections between the Digital Skills Anth collection and the paper "The FAIR Guiding Principles for scientific data management and stewardship" by Wilkinson et al. 2016. The connections within the collection so far are Wilkinson 2016 to Marwick null. Nicholson 2023 and Kansa 2018 are not majorly connected to the web. There are many blue connections to the Wilkinson paper that are not part of the collection.](3.png)
...
![A screenshot of the results for the search "Open Data Archaeology" in the search engine Startpage. The screenshot shows the first four results: the Journal of Open Archaeology Data, the Digital Archaeological Record (tDAR), the Archaeology Data Service in the UK, and Brown University's Archaeological Data LibGuide.](4.png)
...
![A screenshot of the results for the search "Open Data Archaeology" in Google Scholar. The screenshot shows the first four results: Defining and advocating open data in archaeology, Promise and paradox: Accessing open data in archaeology, How community archaeology can make use of open data to achieve further its objectives, and A vision for open archaeology.](5.png)
